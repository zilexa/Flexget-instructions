# this version is a modified version of https://github.com/tarzasai/.flexget/blob/master/plugins/log_filter.py
# this version has been modified by Henrik_Sjodahl (Flexget forum) to support Python 3. He only changed line 7.
